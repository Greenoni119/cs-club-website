  ...
  <div class="bg grid grid-cols-1  gap-5 md:grid-cols-2 lg:grid-cols-3 bg-white rounded-3xl ">
    ...
    <div class="m-10 group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
      ...
      <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
        ...
        <p class="mb-3 text-md text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">Hey I&aposp;m Auner, this year&aposp;s treasurer for the CS club, I&aposp;m a Computer Science major with 4 years of experience. I like to exercise, play video games, and program. My favorite programming language at the moment is Java</p>
      </div>
    </div>
    <div class="m-10 group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
      <div class="h-96 w-72">
      ...
      <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
        ...
        <p class="mb-3 text-sm text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">I&aposp;m Charlie, this is my second year at CSM. I&aposp;ll be earning my degree in computer science for web development in 2023. I&aposp;ve been coding for several years within the field of front-end development and iOS development. I started while I was in the army, Now I devote all my time sharpening my coding skills and helping others.</p>
      </div>
    </div>
    <div class="m-10 group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
      <div class="h-96 w-72">
      ...
      <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
        ...
        <p class="mb-3 text-md text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">What&aposp;s up my name is Aaron and I&aposp;m a Computer Science major. I&aposp;m hoping to transfer to UCLA next year for the fall semester. I love long walks on the beach, cooking like I&aposp;m Ratatouille, playing piano and I think in morse code. Code is my third language after Russian and before English.</p>
      </div>
    </div>
    <div class="m-10 group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
      <div class="h-96 w-72">
      ...
      <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
        ...
        <p class="mb-3 text-md text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">Hi I&aposp;m Keon. I like lifting weights, spending time with my family/dogs, and playing video games. It&aposp;s my first year at CSM and my favorite things about CSM so far are the cool study spots and the decent food. It&aposp;s my first year studying computer science and so far I am having a lot of fun doing it.</p>
      </div>
    </div>
  </div>
