  ...
  <div class=" grid grid-cols-1  gap-5 md:grid-cols-2 lg:grid-cols-3 rounded-3xl ">
    ...
    <div class="m-10 group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
      ...
      <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
        ...
        <p class="mb-3 text-sm text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">I&apos;m Charlie, this is my second year at CSM. I&apos;ll be earning my degree in computer science for web development in 2023. I&apos;ve been coding for several years within the field of front-end development and iOS development. I started while I was in the army, Now I devote all my time sharpening my coding skills and helping others.</p>
      </div>
    </div>
    <div class="m-10 group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
      <div class="h-96 w-72">
